...
int RL = 10000; //Rezystor podciągnięty między pinem 2 czujnika Figaro a masą (dzielnik napiecia)
float RS;
int Ro = 12000;
float VRL1 = 0;
float VRL2 = 0;
...
//Wzór Trimetyl amine: 10*0.04x^-0.9
//Z tego powodu dla 1 ppm jest 0,39 RS/R0 ratio
//I z uwzględnieniem RS/Ro y = x^-0.8 -1
